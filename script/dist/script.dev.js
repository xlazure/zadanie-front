...
var a = 0; ///zmiana w tabeli "dostępność" z "wolne" na "rezerwacja" zmienia tytuł w podświetleniu domów

var mapka = document.querySelectorAll('map area');
var a1 = document.querySelectorAll('#oneA td');
var a2 = document.querySelectorAll('#oneB td');
var a3 = document.querySelectorAll('#twoA td');
var a4 = document.querySelectorAll('#twoB td');
var a5 = document.querySelectorAll('#threeA td');
var a6 = document.querySelectorAll('#threeB td');
var a7 = document.querySelectorAll('#fourA td');
var a8 = document.querySelectorAll('#fourB td');
